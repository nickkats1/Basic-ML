...
class Config:
    """All configuration for the credit-risk classification pipeline."""

    # Raw data source.
    url_link: str = (
        "https://raw.githubusercontent.com/nickkats1/sklearn_only/"
        "refs/heads/main/creditrisk/data/raw/data.csv"
    )

    # Schema (German-credit style; mix of numeric and categorical codes).
    features: tuple[str, ...] = (
        "checkingstatus1",
        "duration",
        "history",
    ...
    experiment_name: str = "creditrisk"
    mlflow_tracking_uri: str = "sqlite:///mlflow.db"

    # Serving.
    app_title: str = "Credit Risk (Default) Prediction"
